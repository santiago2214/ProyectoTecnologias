            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <a href="#"> <i class="menu-icon ti-world"></i>Información General</a>  
        ...
        <div class="content">
            ...
            <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                     <div class="stat-text">Texto1</div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">Texto2</div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">Texto3</div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">Texto4</div>
                ...
                <div class="card weather-box">
                            <h4 class="weather-title box-title">Part 1</h4>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-4">
                        <div class="card">
                        	<h4 class="weather-title box-title">Part 2</h4>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card weather-box">
                            <h4 class="weather-title box-title">Part 3</h4>
                            <div class="card-body">
                                <div class="weather-widget">
                                    <div id="weather-one" class="weather-one"></div>
                                </div>
